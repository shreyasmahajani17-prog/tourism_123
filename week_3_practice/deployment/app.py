...
model_path = hf_hub_download(repo_id="shreyas1997/predictor-tourism-package/tourism_package_prediction_model", filename="best_tourism_package_prediction_model_v1.joblib")
