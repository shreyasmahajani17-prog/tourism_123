...
DATASET_PATH = "hf://datasets/shreyas1997/predictor-tourism-package/tourism-purchase-analysis/tourism.csv"
...
for file_path in files:
    api.upload_file(
        ...
        repo_id="shreyas1997/predictor-tourism-package/tourism-purchase-analysis",
        repo_type="dataset",
    )
